...
for l in order_vector:
	for i in range(10,20):
		...
		#print("For Japanese:")
		#print(log_probability, print_exp(log_probability))
		prediction = order_vector[log_probability_list.index(max(log_probability_list))]

		true_label = l

		confusion_matrix[order_vector.index(prediction)][order_vector.index(true_label)] = confusion_matrix[order_vector.index(prediction)] [order_vector.index(true_label)] +1
